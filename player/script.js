...
let ishuffled = false;
let repeatOn = false;
const orignalPlaylist = JSON.parse(localStorage.getItem('playlist')) ?? [asYouWere,home, fallen, Evanescence];
...
function likeButtonClicked() {
    ...
    likeButtonRender();
    localStorage.setItem('playlist', JSON.stringify(orignalPlaylist));
}
